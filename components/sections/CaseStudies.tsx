          ...
          {/* <article className="bg-white rounded-xl overflow-hidden shadow-sm group">
            ...
            <div className="p-8">
              ...
              <p className="text-on-surface-variant mb-6">
                Transitioning a heritage brand into a high-conversion e-commerce
                powerhouse.
              </p>
              <div className="flex justify-between items-center pt-6 border-t border-surface-container">
                <div>
                ...
                <span className="material-symbols-outlined text-[#241E20] group-hover:translate-x-2 transition-transform">
                  arrow_forward
                </span>
              </div>
            </div>
